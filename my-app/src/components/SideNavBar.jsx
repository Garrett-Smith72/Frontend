...
export default function SideNavBar({ currentPath }) {
  const links = [
  ...
  return (
    <nav className="hidden md:flex flex-col bg-[#111317] docked left-0 h-full w-64 border-r-0 fixed top-0 z-50 tonal-layering bg-[#1a1c1f]">
      {/* Header / Identity */}
      ...
      {/* Navigation Links */}
      <div className="flex-1 py-6 flex flex-col gap-1 font-mono text-sm instant feedback 100ms">
        {links.map((link) => {
